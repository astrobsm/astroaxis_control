...
# Use verbatim here-string to prevent PowerShell interpretation
$newSettings = @"
<div className="settings-grid">
              ...
              <div className="settings-card">
                ...
                <div className="form-group"><input type="checkbox" defaultChecked/> <span style={{marginLeft:'8px'}}>HR and Staff Module</span></div>
...
if ($content.Contains($oldSettings)) {
    $content = $content.Replace($oldSettings, $newSettings)
    Write-Host "✅ Settings Module: Enhanced" -ForegroundColor Green
} else {
    Write-Host "⚠️  Settings Module: Pattern not found" -ForegroundColor Yellow
}
...
{/* Payment Status Card */}
              ...
              {/* Staff and Attendance Card */}
              <div className="report-card">
                <h3>👥 Staff and Attendance</h3>
                <div className="report-stats">
...
if ($content.Contains($oldReports)) {
    $content = $content.Replace($oldReports, $newReports)
    Write-Host "✅ Reports Module: Expanded" -ForegroundColor Green
} else {
    Write-Host "⚠️  Reports Module: Pattern not found" -ForegroundColor Yellow
}
...
Write-Host "🎯 Next: Review changes and run 'npm run build'" -ForegroundColor Yellow
