#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fix ASTRO-ASIX UI Modules - Updates Settings, Reports, and Sales Order Form"""
...
print("🔧 Fixing ASTRO-ASIX UI Modules...")
...
# FIX 1: Enhanced Settings Module
old_settings = '<div className="settings-card"><h3>Company</h3><div className="form-group"><label>Company Name</label><input type="text" defaultValue="ASTRO-ASIX"/></div></div>'

new_settings = '''<div className="settings-grid">
              {/* Company Information */}
...
if old_settings in content:
    ...
    print("✅ Settings Module: Enhanced with 6 comprehensive setting cards")
else:
    print("⚠️  Settings Module: Original pattern not found, skipping...")

# FIX 2: Enhanced Reports Module
old_reports = """<div className="report-card"><h3>Payment Status</h3><div className="report-stats"><div className="stat"><span className="label">Paid:</span><span className="value">{(data.sales||[]).filter(s=>s.payment_status==='paid').length}</span></div><div className="stat"><span className="label">Unpaid:</span><span className="value text-danger">{(data.sales||[]).filter(s=>s.payment_status==='unpaid').length}</span></div></div></div>"""

new_reports = '''{/* Payment Status Card */}
...
if old_reports in content:
    ...
    print("✅ Reports Module: Expanded with 6 detailed report cards")
else:
    print("⚠️  Reports Module: Original pattern not found, skipping...")
...
print("🎯 Next: Run 'npm run build' to compile changes")
