// Archived backup of AppMain before emoji cleanup.
// This file intentionally contains no UI code to avoid bundling or reintroducing mojibake.
// Refer to AppMain.js for the current implementation.

export const APPMAIN_BACKUP_NOTE = 'Archived backup (clean, no emojis). See AppMain.js for live code.';
                  ...
                  {(data.products || []).map(product => (
                    <tr key={product.id}>
                      ...
                      <td className="actions">
                        ...
                        <button onClick={() => openForm('stockIntake', { product_id: product.id })} className="btn-add">Add Stock</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
                ...
                <tbody>
                  {(data.sales||[]).map(order => (
                    <tr key={order.id}>
                      ...
                      <td className="actions">
                        <button onClick={() => generateInvoice(order.id)} className="btn-invoice">Invoice</button>
                  ...
                  <div className="lines-section">
                    ...
                    {(forms.salesOrder.lines||[]).map((line, idx) => (
                      <div key={idx} className="form-row line-row">
                        ...
                        <div className="form-group"><button type="button" className="btn btn-danger" onClick={()=>removeSalesLine(idx)}>×</button></div>
                      </div>
                    ))}
                  </div>
